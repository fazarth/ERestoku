...
<body>
		...
		<div class="container">
			...
			<table class="table table-striped">
				...
				<tfoot>
						<th colspan="4" class="text-center">Total Pesanan Anda</th>
		...
		<div class="container">
			...
			<form method="post">
					<select class="custom-select" id="validationTooltip04" name="nomormeja" required>
						<option selected disabled value="">Pilih Meja Anda</option>
							<?php 
	...
	//menyimpan data ke tabel pembelian
				...
				$tambah = $koneksi->query("INSERT INTO pembelian (id_meja,tanggal_pembelian,total_pembelian) VALUES ('$id_meja','$tanggal_pembelian','$total_pembelian')");
				if ($tambah) {
